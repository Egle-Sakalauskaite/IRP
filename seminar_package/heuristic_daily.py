...
def heuristic_main(parameters, upper_bound_forecast, SAFETY_TIME, MINIMUM_DELIVERY_QUANTITY_PROPORTION, day, initial_inventory, initial_trailer_tank):
    # initialization
    ...
    time_periods, time_horizon = hh.periods_of_the_day(parameters["time windows"], day, parameters["time horizon"])
    solution = []
